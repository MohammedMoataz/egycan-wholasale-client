...
const ProductsPage: React.FC = () => {
  ...
  const productId = searchParams.get('id') ? Number(searchParams.get('id')) : undefined;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        ...
        {/* Filters Sidebar */}
        <div className={`w-full md:w-1/4 bg-white p-4 rounded-lg shadow-md ${showFilters ? 'block' : 'hidden md:block'}`}>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => handleFilterChange('brandId', e.target.value || null)}
              className="w-full p-2 border rounded-md"
            >
